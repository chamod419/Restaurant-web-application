...
<section class="dashboard">
   ...
   <h1 class="heading">Welcome To The Admin Dashboard</h1>
   ...
   <div class="box">
      ...
      <p>meals added</p>
      <a href="products.php" class="btn">see meals</a>
   </div>
   ...
   <div class="box">
      ...
      ?>
      <h3><?= $numbers_of_events; ?></h3>
      <p>events added</p>
      <a href="admin_events.php" class="btn">see events</a>
   </div>
   ...
   <div class="box">
      ...
      <a href="../admin/staff_reservations.php" class="btn">See Reservations</a>
   </div>
