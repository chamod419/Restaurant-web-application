...
<div class="heading">
   ...
   <p> <span>Pre-Order Checkout/<a href="home.php">Home</a></span></p>
</div>

<section class="checkout">

   <h1 class="tittle">Pre-Order Summary</h1>
...
<form action="" method="post">
   ...
   <input type="hidden" name="total_products" value="<?= isset($total_products) ? $total_products : ''; ?>">  <!-- Ensure $total_products is set -->
   <input type="hidden" name="total_price" value="<?= $grand_total; ?>">
   <input type="hidden" name="name" value="<?= isset($fetch_profile['name']) ? $fetch_profile['name'] : ''; ?>">  <!-- Ensure $fetch_profile is set -->
